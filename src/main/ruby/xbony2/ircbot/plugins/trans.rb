class Trans
  ...
  def execute(msg, page, special)
    if msg.user.authname != $OWNER_NAME
      ...
      ["name", "lore", "module", "effects", "storageslots", "storage",  "exp", "modpacks", "requires", "dependency", "neededfor", "neededforpast", "requirespast",  "dependecypast", 
        "description"].each {|s| #Does parameters
      ...
      text = text.insert(0, "<translate><!--Translators note: you don't needed to translate this line. Just copy-paste it over. Anyway, this page was originally translated before " + 
        ...
        "[[User:Xbony2#My_subpages]]--></translate>\n") if special == "in"
